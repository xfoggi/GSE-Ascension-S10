...
L["%s does not fit in a macro: %d characters against the 255 WoW allows. Everything past the cut is dropped, KeyRelease first and then the step itself. Shorten KeyPress, or turn off Prevent Sound Errors, which adds about 220 on its own."] = true
L["Reset modifier %s is not available inside a macro and has been ignored."] = true
L["Hold while channelling"] = true
L["Raid / Party / Dungeon / Heroic / Mythic / PVP"] = true
